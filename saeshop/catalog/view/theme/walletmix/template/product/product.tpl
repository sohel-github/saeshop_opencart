...
<div class="container">
    ...
    <ul class="breadcrumb">
      ...
      <?php } ?>
		...
		<div class="col-sm-5" style="border:1px dotted #222;">
			<ul class="detail_thumbnails">
      ...
      <?php } ?>
            ...
            <div class="form-group">
              ...
              <input type="text" name="quantity" value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="" />
...
$(document).ready(function() {
	$('.detail_thumbnails').magnificPopup({
		type:'image',
		delegate: 'a',
		gallery: {
			enabled:true
